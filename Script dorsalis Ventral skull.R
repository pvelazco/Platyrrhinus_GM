...
########################################################################
# GPA (Generalized Procrustes Analysis - Análise Generalizada de Procrustes)
...
# Remove specimens/outliers.If you want to remove one or more individuals from your dataset: here we want to remove individuals 29 and 32. 
tps<-tps[,,-c(29,32)] 
plan<-plan[-c(29,32),]
...
links<-
  matrix(c(1,3,3,4,4,7,7,8,8,9,9,12,1,2,2,3),nrow=8,ncol=2,byrow=T)
...
PCA<-gm.prcomp(shape) 
xlab<-"Principal Component 1 (24.11%)"
ylab<-"Principal Component 2 (12.55%)"
