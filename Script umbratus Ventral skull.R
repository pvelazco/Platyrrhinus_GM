...
# Test: Variation in size within species (considering two separate group)
...
PCA<-gm.prcomp(shape) 
xlab<-"Principal Component 1 (19.37%)"
ylab<-"Principal Component 2 (12.77%)"
